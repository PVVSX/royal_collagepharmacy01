    ...
    <>
      <PageShell>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">{filtered.map((item) => { const c = cm[item.categoryColor]; return (
          <Card key={item.id} className={`card-shadow border-t-4 border-l-0 ${c.border} hover:shadow-md transition-all hover:-translate-y-1 overflow-hidden flex flex-col`}>
