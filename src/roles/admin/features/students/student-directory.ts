...
export const adminStudentDirectory = [
  { id: "RPC-2569-001", title: "ภญ.", firstName: "คารินา", lastName: "วัฒนกุล", firstNameEn: "Karina", lastNameEn: "Wattanakul", licenseNumber: "ภ.34567", program: "เภสัชบำบัด", collegeShort: "วภท.", year: "2569", trainingStatus: "normal", continuingEducationStatus: "active", cpdCredits: 30, cpdTarget: 100, email: "karina.w@example.com", phone: "081-234-5678" },
