        ...
        <Card className="w-full max-w-lg border-danger-border">
          <CardContent className="flex flex-col items-center px-6 py-10 text-center">
            ...
            <h1 className="mt-4 text-xl font-semibold text-foreground">
              {hasPresidentRole ? "วาระไม่อยู่ในช่วงที่มีผล" : "ไม่มีสิทธิ์เข้าถึงส่วนของประธานวิทยาลัย"}
            </h1>
            <p className="mt-2 max-w-md text-sm leading-relaxed text-muted-foreground">
              {hasPresidentRole
                ...
                : "กรุณาเข้าสู่ระบบด้วยบัญชีประธานวิทยาลัยที่ได้รับมอบหมายและมีวาระปัจจุบัน"}
            </p>
